...
const EditorPanel = ({
  ...
  return (
    <div className="absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-40 animate-in fade-in slide-in-from-right-5">
      <div className="flex justify-between items-center mb-4">
        <h3 className="font-semibold text-gray-800">Edit Panel</h3>
        <button className="p-1 rounded-full hover:bg-gray-100">
          <XIcon onClick={onClose} className="size-4 text-gray-500" />
        </button>
      </div>
