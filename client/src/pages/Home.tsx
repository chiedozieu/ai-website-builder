  ...
  return (
    <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
      ...
      <p className="text-center text-base max-w-md mt-2">
        Create, customize and publish websites faster than ever with intelligent design
        powered by AI.
      </p>
      ...
      >
        ...
        <button className="ml-auto flex items-center gap-2 bg-linear-to-r from-[#CB52D4] to-indigo-600 rounded-md px-4 py-2">
            {
                !loading ? "Create with AI" : <>  Creating <Loader2 className="animate-spin size-4 text-white" /></>
            }
