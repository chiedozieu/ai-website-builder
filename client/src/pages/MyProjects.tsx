        ...
        {loading ? (
          ...
          <div className="py-10 min-h-[80vh]">
            <div className="flex items-center justify-between mb-12">
              ...
              <button
                onClick={() => navigate("/")}
                className="flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-br from-indigo-500 to bg-indigo-600 hover:opacity-90 active:scale-95 transition-all"
              >
              ...
              {projects.map((project) => (
                ...
                >
                  ...
                  <div className="relative w-full h-40 bg-gray-900 overflow-hidden border-b border-gray-800">
                    {project.current_code ? (
                      ...
                      <div className="flex items-center justify-center h-full text-gray-500">
                        <p className="">No Preview</p>
                      </div>
                    )}
                  </div>
                  {/* Content */}
                  <div className="p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-all">
                    <div className="flex items-start justify-between">
                      <h2 className="text-lg font-medium line-clamp-2">
                        {project.name}
                      </h2>
                      <button className="px-2.5 py-0.5 mt-1 ml-2 text-xs font-medium rounded-full bg-gray-800 border border-gray-700">
                        Website
                      </button>
                    </div>
                  ...
                  <div onClick={(e) => e.stopPropagation()} className="">
                    <Trash2Icon onClick={() => deleteProject(project.id)} className="absolute top-3 right-3 scale-0 group-hover:scale-100 bg-white p-1.5 size-7 text-red-500 rounded-full text-xl cursor-pointer transition-all" />
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="flex flex-col items-center gap-3 justify-center h-[80vh]">
